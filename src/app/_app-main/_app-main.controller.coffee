class Root extends Controller
  constructor: ($scope, $window) ->
    ...
    defaultDesc =
      'This study looks at AngularJS boilerplates to find the best approaches.
      Although plenty of choices are available,
      they will do justice for only some types of applications.'
    ...
    ###
      ...
      Other available params for $stateChangeSuccess:
    ...
    ###
    $scope.$on('changedTitle', (event, pageTitle) ->
